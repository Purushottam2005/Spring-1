...
public class T01I001 implements AuthUser, Serializable {
	...
	@Embedded
	private AuditUser audit = new AuditUser();
	...
	public AuditUser getAudit() {
		return audit;
	}

	public void setAudit(AuditUser audit) {
		this.audit = audit;
	}
